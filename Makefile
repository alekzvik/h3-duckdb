...
BUILD_FLAGS=-DEXTENSION_STATIC_BUILD=1 -DBUILD_EXTENSIONS="tpch" ${OSX_BUILD_UNIVERSAL_FLAG} ${STATIC_LIBCPP}

CLIENT_FLAGS :=

# These flags will make DuckDB build the extension
EXTENSION_FLAGS=-DDUCKDB_EXTENSION_NAMES="h3" -DDUCKDB_EXTENSION_H3_PATH="$(PROJ_DIR)" -DDUCKDB_EXTENSION_H3_SHOULD_LINK=1 -DDUCKDB_EXTENSION_H3_INCLUDE_PATH="$(PROJ_DIR)src/include"
